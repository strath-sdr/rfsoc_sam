-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_FFT_HDL_Optimized_128.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_FFT_HDL_Optimized_128
...
ENTITY SpectrumAnalyser_src_FFT_HDL_Optimized_128 IS
...
END SpectrumAnalyser_src_FFT_HDL_Optimized_128;


ARCHITECTURE rtl OF SpectrumAnalyser_src_FFT_HDL_Optimized_128 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_2_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_2_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_TWDLROM_3_1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_3_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_3_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_4_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_TWDLROM_5_1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_5_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_6_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_6_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_TWDLROM_7_1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX2FFT_bitNatural_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_2_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_2_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_2_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_2_block(rtl);

  FOR ALL : SpectrumAnalyser_src_TWDLROM_3_1_block
    USE ENTITY work.SpectrumAnalyser_src_TWDLROM_3_1_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_3_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_3_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_3_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_3_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_4_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_4_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block(rtl);

  FOR ALL : SpectrumAnalyser_src_TWDLROM_5_1_block
    USE ENTITY work.SpectrumAnalyser_src_TWDLROM_5_1_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_5_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_5_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_6_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_6_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_6_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_6_block(rtl);

  FOR ALL : SpectrumAnalyser_src_TWDLROM_7_1_block
    USE ENTITY work.SpectrumAnalyser_src_TWDLROM_7_1_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block1
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block1(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX2FFT_bitNatural_block
    USE ENTITY work.SpectrumAnalyser_src_RADIX2FFT_bitNatural_block(rtl);
...
BEGIN
  u_CTRL1_1_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_1_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_2_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_2_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_2_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_1_1_re => dout_1_1_re,  -- sfix17_En15
  ...
  u_twdlROM_3_1 : SpectrumAnalyser_src_TWDLROM_3_1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_3_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_3_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_3_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_4_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_4_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_3_1_re => dout_3_1_re,  -- sfix19_En15
  ...
  u_twdlROM_5_1 : SpectrumAnalyser_src_TWDLROM_5_1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_5_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_5_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_6_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_6_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_6_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_5_1_re => dout_5_1_re,  -- sfix21_En15
  ...
  u_twdlROM_7 : SpectrumAnalyser_src_TWDLROM_7_1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_CTRLRX2 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_1_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_RADIX2 : SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_NaturalOrder_Stage : SpectrumAnalyser_src_RADIX2FFT_bitNatural_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_7_re => dout_7_re,  -- sfix23_En15
