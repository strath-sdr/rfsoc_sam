...
BEGIN
  ...
  Unit_Delay_Enabled_Synchronous_ectrl(0) <= Unit_Delay_Enabled_Synchronous_out1(0) WHEN Compare_To_Constant8_out1 = '0' ELSE
      Selector12_out1_1(0);
  
  Unit_Delay_Enabled_Synchronous_ectrl(1) <= Unit_Delay_Enabled_Synchronous_out1(1) WHEN Compare_To_Constant8_out1 = '0' ELSE
      Selector12_out1_1(1);
  ...
  Unit_Delay_Enabled_Synchronous1_ectrl(0) <= Unit_Delay_Enabled_Synchronous1_out1(0) WHEN Compare_To_Constant9_out1 = '0' ELSE
      Selector9_out1_1(0);
  
  Unit_Delay_Enabled_Synchronous1_ectrl(1) <= Unit_Delay_Enabled_Synchronous1_out1(1) WHEN Compare_To_Constant9_out1 = '0' ELSE
      Selector9_out1_1(1);
  ...
  Unit_Delay_Enabled_Synchronous2_ectrl(0) <= Unit_Delay_Enabled_Synchronous2_out1(0) WHEN Compare_To_Constant10_out1 = '0' ELSE
      Selector10_out1_1(0);
  
  Unit_Delay_Enabled_Synchronous2_ectrl(1) <= Unit_Delay_Enabled_Synchronous2_out1(1) WHEN Compare_To_Constant10_out1 = '0' ELSE
      Selector10_out1_1(1);
  ...
  Unit_Delay_Enabled_Synchronous3_ectrl(0) <= Unit_Delay_Enabled_Synchronous3_out1(0) WHEN Compare_To_Constant11_out1 = '0' ELSE
      Selector11_out1_1(0);
  
  Unit_Delay_Enabled_Synchronous3_ectrl(1) <= Unit_Delay_Enabled_Synchronous3_out1(1) WHEN Compare_To_Constant11_out1 = '0' ELSE
      Selector11_out1_1(1);
