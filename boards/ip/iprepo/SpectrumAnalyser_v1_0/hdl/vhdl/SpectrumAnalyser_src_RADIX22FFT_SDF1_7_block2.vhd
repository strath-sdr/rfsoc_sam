-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block2
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block2 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block2;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF1_7_block2 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_Complex4Multiply_block13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator7_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_Complex4Multiply_block13
    USE ENTITY work.SpectrumAnalyser_src_Complex4Multiply_block13(rtl);

  FOR ALL : SpectrumAnalyser_src_SDFCommutator7_block2
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator7_block2(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser_src_Complex4Multiply_block13
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_7 : SpectrumAnalyser_src_SDFCommutator7_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
