...
BEGIN
  ...
  debug_valid_des <= SSR_Deserializer_Real_out1;

  debug_sof_des <= SSR_Deserializer_Real_out3;

  debug_eol_des <= SSR_Deserializer_Real_out4;

  debug_valid_pgen <= SSR_Packet_Generator_Real_out1;

  debug_sof_pgen <= SSR_Packet_Generator_Real_out3;

  debug_eol_pgen <= SSR_Packet_Generator_Real_out4;

  debug_valid_ser <= SSR_Serializer_Real_out1;

  Data_Real_Out <= SSR_Deserializer_Real_out2;

  Data_Imag_Out <= SSR_Deserializer_Imag_out2;

  debug_data_des <= SSR_Deserializer_Real_out2;
