...
BEGIN
  ...
  Unit_Delay_Enabled_Synchronous7_ectrl <= Unit_Delay_Enabled_Synchronous7_out1 WHEN Compare_To_Constant_out1 = '0' ELSE
      Data_In_0;
  ...
  Unit_Delay_Enabled_Synchronous6_ectrl <= Unit_Delay_Enabled_Synchronous6_out1 WHEN Compare_To_Constant1_out1 = '0' ELSE
      Data_In_0_1;
  ...
  Unit_Delay_Enabled_Synchronous5_ectrl <= Unit_Delay_Enabled_Synchronous5_out1 WHEN Compare_To_Constant2_out1 = '0' ELSE
      Data_In_0_2;
  ...
  Unit_Delay_Enabled_Synchronous4_ectrl <= Unit_Delay_Enabled_Synchronous4_out1 WHEN Compare_To_Constant3_out1 = '0' ELSE
      Data_In_0_3;
  ...
  Unit_Delay_Enabled_Synchronous3_ectrl <= Unit_Delay_Enabled_Synchronous3_out1 WHEN Compare_To_Constant4_out1 = '0' ELSE
      Data_In_0_4;
  ...
  Unit_Delay_Enabled_Synchronous2_ectrl <= Unit_Delay_Enabled_Synchronous2_out1 WHEN Compare_To_Constant5_out1 = '0' ELSE
      Data_In_0_5;
  ...
  Unit_Delay_Enabled_Synchronous1_ectrl <= Unit_Delay_Enabled_Synchronous1_out1 WHEN Compare_To_Constant6_out1 = '0' ELSE
      Data_In_0_6;
  ...
  Unit_Delay_Enabled_Synchronous_ectrl <= Unit_Delay_Enabled_Synchronous_out1 WHEN Compare_To_Constant7_out1 = '0' ELSE
      Data_In_0_7;
