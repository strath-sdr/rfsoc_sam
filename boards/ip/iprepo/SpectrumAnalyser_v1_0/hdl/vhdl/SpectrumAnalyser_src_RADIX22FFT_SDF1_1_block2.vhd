-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block2
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block2 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block2;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF1_1_block2 IS
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator1_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_SDFCommutator1_block2
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator1_block2(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : SpectrumAnalyser_src_SDFCommutator1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
