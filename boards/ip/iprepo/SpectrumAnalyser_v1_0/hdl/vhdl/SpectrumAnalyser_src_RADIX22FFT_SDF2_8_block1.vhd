-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block1
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block1 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block1;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block1 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_SDFCommutator8_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_SDFCommutator8_block1
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator8_block1(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_8 : SpectrumAnalyser_src_SDFCommutator8_block1
    PORT MAP( clk => clk,
              reset => reset,
