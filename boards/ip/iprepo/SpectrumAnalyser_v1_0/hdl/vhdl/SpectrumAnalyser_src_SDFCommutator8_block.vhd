-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_SDFCommutator8_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_SDFCommutator8_block
...
ENTITY SpectrumAnalyser_src_SDFCommutator8_block IS
...
END SpectrumAnalyser_src_SDFCommutator8_block;


ARCHITECTURE rtl OF SpectrumAnalyser_src_SDFCommutator8_block IS
...
BEGIN
  u_dataXMEM_re_0_8 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_8 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
