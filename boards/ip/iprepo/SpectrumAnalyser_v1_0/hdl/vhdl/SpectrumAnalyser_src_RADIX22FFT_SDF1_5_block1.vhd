-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block1
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block1 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block1;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block1 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_Complex4Multiply_block7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator5_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_Complex4Multiply_block7
    USE ENTITY work.SpectrumAnalyser_src_Complex4Multiply_block7(rtl);

  FOR ALL : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : SpectrumAnalyser_src_SDFCommutator5_block1
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator5_block1(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser_src_Complex4Multiply_block7
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_5 : SpectrumAnalyser_src_SDFCommutator5_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_5_vld_dly => din_5_vld_dly,
