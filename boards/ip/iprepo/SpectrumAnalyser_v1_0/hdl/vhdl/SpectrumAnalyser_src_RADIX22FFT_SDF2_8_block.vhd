-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF2_8_block IS
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_SDFCommutator8_block
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator8_block(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_8 : SpectrumAnalyser_src_SDFCommutator8_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
