-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF1_11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF1_11
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF1_11 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF1_11;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF1_11 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_Complex4Multiply_block10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_Complex4Multiply_block10
    USE ENTITY work.SpectrumAnalyser_src_Complex4Multiply_block10(rtl);

  FOR ALL : SpectrumAnalyser_src_SDFCommutator11
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator11(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser_src_Complex4Multiply_block10
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_11 : SpectrumAnalyser_src_SDFCommutator11
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_11_vld_dly => din_11_vld_dly,
