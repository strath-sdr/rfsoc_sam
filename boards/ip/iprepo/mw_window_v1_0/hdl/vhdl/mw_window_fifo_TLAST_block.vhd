-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_fifo_TLAST_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_fifo_TLAST_block
-- Source Path: mw_window/mw_window_axi4_stream_imag_slave/mw_window_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_fifo_TLAST_block IS
...
END mw_window_fifo_TLAST_block;


ARCHITECTURE rtl OF mw_window_fifo_TLAST_block IS
...
BEGIN
  ...
  u_mw_window_fifo_TLAST_classic_ram : mw_window_SimpleDualPortRAM_singlebit
