-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_axi_lite_module
-- Source Path: mw_window/mw_window_axi_lite/mw_window_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_axi_lite_module IS
...
END mw_window_axi_lite_module;


ARCHITECTURE rtl OF mw_window_axi_lite_module IS

  -- Component Declarations
  COMPONENT mw_window_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : mw_window_reset_hold
    USE ENTITY work.mw_window_reset_hold(rtl);
...
BEGIN
  u_mw_window_reset_hold_inst : mw_window_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
              reset_in => soft_reset,  -- ufix1
              in_burst => in_burst_axi4_master_rd,  -- ufix1
