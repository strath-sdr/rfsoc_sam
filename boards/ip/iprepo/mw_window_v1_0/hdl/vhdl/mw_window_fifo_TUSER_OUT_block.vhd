-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_fifo_TUSER_OUT_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_fifo_TUSER_OUT_block
-- Source Path: mw_window/mw_window_axi4_stream_imag_master/mw_window_fifo_TUSER_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_fifo_TUSER_OUT_block IS
...
END mw_window_fifo_TUSER_OUT_block;


ARCHITECTURE rtl OF mw_window_fifo_TUSER_OUT_block IS
...
BEGIN
  ...
  u_mw_window_fifo_TUSER_OUT_classic_ram : mw_window_SimpleDualPortRAM_singlebit
