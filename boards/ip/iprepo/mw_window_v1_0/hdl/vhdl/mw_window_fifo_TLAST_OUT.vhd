-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_fifo_TLAST_OUT
-- Source Path: mw_window/mw_window_axi4_stream_real_master/mw_window_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_fifo_TLAST_OUT IS
...
END mw_window_fifo_TLAST_OUT;


ARCHITECTURE rtl OF mw_window_fifo_TLAST_OUT IS
...
BEGIN
  ...
  u_mw_window_fifo_TLAST_OUT_classic_ram_singlebit : mw_window_SimpleDualPortRAM_singlebit
