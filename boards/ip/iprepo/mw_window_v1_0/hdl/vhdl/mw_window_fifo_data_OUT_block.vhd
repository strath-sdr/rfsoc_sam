-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_fifo_data_OUT_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_fifo_data_OUT_block
-- Source Path: mw_window/mw_window_axi4_stream_imag_master/mw_window_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_fifo_data_OUT_block IS
...
END mw_window_fifo_data_OUT_block;


ARCHITECTURE rtl OF mw_window_fifo_data_OUT_block IS

  -- Component Declarations
  COMPONENT mw_window_SimpleDualPortRAM_generic
  ...
  FOR ALL : mw_window_SimpleDualPortRAM_generic
    USE ENTITY work.mw_window_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_mw_window_fifo_data_OUT_classic_ram : mw_window_SimpleDualPortRAM_generic
