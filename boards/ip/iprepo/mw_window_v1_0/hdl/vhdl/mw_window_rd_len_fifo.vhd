-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_rd_len_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_rd_len_fifo
-- Source Path: mw_window/mw_window_axi4_master_rd/mw_window_rd_len_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_rd_len_fifo IS
...
END mw_window_rd_len_fifo;


ARCHITECTURE rtl OF mw_window_rd_len_fifo IS
...
BEGIN
  ...
  u_mw_window_rd_len_fifo_classic_ram : mw_window_SimpleDualPortRAM_generic
