-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_axi4_master_rd.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_axi4_master_rd
-- Source Path: mw_window/mw_window_axi4_master_rd
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_axi4_master_rd IS
...
END mw_window_axi4_master_rd;


ARCHITECTURE rtl OF mw_window_axi4_master_rd IS

  -- Component Declarations
  COMPONENT mw_window_rd_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_window_rd_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_window_rdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : mw_window_rd_addr_fifo
    USE ENTITY work.mw_window_rd_addr_fifo(rtl);

  FOR ALL : mw_window_rd_len_fifo
    USE ENTITY work.mw_window_rd_len_fifo(rtl);

  FOR ALL : mw_window_rdata_fifo
    USE ENTITY work.mw_window_rdata_fifo(rtl);
...
BEGIN
  u_mw_window_rd_addr_fifo_inst : mw_window_rd_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_mw_window_rd_len_fifo_inst : mw_window_rd_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_mw_window_rdata_fifo_inst : mw_window_rdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
