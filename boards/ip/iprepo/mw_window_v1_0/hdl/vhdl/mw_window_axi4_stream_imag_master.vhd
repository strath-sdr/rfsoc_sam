-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_axi4_stream_imag_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_axi4_stream_imag_master
-- Source Path: mw_window/mw_window_axi4_stream_imag_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_axi4_stream_imag_master IS
...
END mw_window_axi4_stream_imag_master;


ARCHITECTURE rtl OF mw_window_axi4_stream_imag_master IS

  -- Component Declarations
  COMPONENT mw_window_fifo_data_OUT_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_window_fifo_TLAST_OUT_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_window_fifo_TUSER_OUT_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : mw_window_fifo_data_OUT_block
    USE ENTITY work.mw_window_fifo_data_OUT_block(rtl);

  FOR ALL : mw_window_fifo_TLAST_OUT_block
    USE ENTITY work.mw_window_fifo_TLAST_OUT_block(rtl);

  FOR ALL : mw_window_fifo_TUSER_OUT_block
    USE ENTITY work.mw_window_fifo_TUSER_OUT_block(rtl);
...
BEGIN
  u_mw_window_fifo_data_OUT_inst : mw_window_fifo_data_OUT_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_mw_window_fifo_TLAST_OUT_inst : mw_window_fifo_TLAST_OUT_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_mw_window_fifo_TUSER_OUT_inst : mw_window_fifo_TUSER_OUT_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
