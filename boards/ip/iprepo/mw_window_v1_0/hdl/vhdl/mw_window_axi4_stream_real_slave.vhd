-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_axi4_stream_real_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_axi4_stream_real_slave
-- Source Path: mw_window/mw_window_axi4_stream_real_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_axi4_stream_real_slave IS
...
END mw_window_axi4_stream_real_slave;


ARCHITECTURE rtl OF mw_window_axi4_stream_real_slave IS

  -- Component Declarations
  COMPONENT mw_window_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_window_fifo_TLAST
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_window_fifo_TUSER
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : mw_window_fifo_data
    USE ENTITY work.mw_window_fifo_data(rtl);

  FOR ALL : mw_window_fifo_TLAST
    USE ENTITY work.mw_window_fifo_TLAST(rtl);

  FOR ALL : mw_window_fifo_TUSER
    USE ENTITY work.mw_window_fifo_TUSER(rtl);
...
BEGIN
  u_mw_window_fifo_data_inst : mw_window_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_mw_window_fifo_TLAST_inst : mw_window_fifo_TLAST
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_mw_window_fifo_TUSER_inst : mw_window_fifo_TUSER
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
