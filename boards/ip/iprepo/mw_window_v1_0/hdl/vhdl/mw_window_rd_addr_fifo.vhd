-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_window\mw_window_rd_addr_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_window_rd_addr_fifo
-- Source Path: mw_window/mw_window_axi4_master_rd/mw_window_rd_addr_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_window_rd_addr_fifo IS
...
END mw_window_rd_addr_fifo;


ARCHITECTURE rtl OF mw_window_rd_addr_fifo IS
...
BEGIN
  ...
  u_mw_window_rd_addr_fifo_classic_ram_generic : mw_window_SimpleDualPortRAM_generic
