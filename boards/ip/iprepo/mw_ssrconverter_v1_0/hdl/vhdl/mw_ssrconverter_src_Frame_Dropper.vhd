-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_Frame_Dropper.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_Frame_Dropper
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Packet Generator Imag/Frame Dropper
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_Frame_Dropper IS
...
END mw_ssrconverter_src_Frame_Dropper;


ARCHITECTURE rtl OF mw_ssrconverter_src_Frame_Dropper IS
