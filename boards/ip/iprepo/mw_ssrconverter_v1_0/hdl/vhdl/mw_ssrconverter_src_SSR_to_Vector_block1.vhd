-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_SSR_to_Vector_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_SSR_to_Vector_block1
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Serializer Imag/SSR to Vector
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_SSR_to_Vector_block1 IS
  PORT( SSR                               :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
        Vector                            :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
        );
END mw_ssrconverter_src_SSR_to_Vector_block1;


ARCHITECTURE rtl OF mw_ssrconverter_src_SSR_to_Vector_block1 IS
