-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_SSR_Packet_Generator_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_SSR_Packet_Generator_Real
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Packet Generator Real
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_SSR_Packet_Generator_Real IS
...
END mw_ssrconverter_src_SSR_Packet_Generator_Real;


ARCHITECTURE rtl OF mw_ssrconverter_src_SSR_Packet_Generator_Real IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_src_TLAST_Generator_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  COMPONENT mw_ssrconverter_src_Frame_Dropper_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  FOR ALL : mw_ssrconverter_src_TLAST_Generator_block
    USE ENTITY work.mw_ssrconverter_src_TLAST_Generator_block(rtl);

  FOR ALL : mw_ssrconverter_src_Frame_Dropper_block
    USE ENTITY work.mw_ssrconverter_src_Frame_Dropper_block(rtl);
...
BEGIN
  u_TLAST_Generator : mw_ssrconverter_src_TLAST_Generator_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Valid_In => Valid_In,
  ...
  u_Frame_Dropper : mw_ssrconverter_src_Frame_Dropper_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
