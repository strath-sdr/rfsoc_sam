-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_SSR_Deserializer_Imag.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_SSR_Deserializer_Imag
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Deserializer Imag
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_SSR_Deserializer_Imag IS
...
END mw_ssrconverter_src_SSR_Deserializer_Imag;


ARCHITECTURE rtl OF mw_ssrconverter_src_SSR_Deserializer_Imag IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_src_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  COMPONENT mw_ssrconverter_src_HDL_FIFO
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_ssrconverter_src_Subsystem1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : mw_ssrconverter_src_Subsystem
    USE ENTITY work.mw_ssrconverter_src_Subsystem(rtl);

  FOR ALL : mw_ssrconverter_src_HDL_FIFO
    USE ENTITY work.mw_ssrconverter_src_HDL_FIFO(rtl);

  FOR ALL : mw_ssrconverter_src_Subsystem1
    USE ENTITY work.mw_ssrconverter_src_Subsystem1(rtl);

  FOR ALL : mw_ssrconverter_src_SSR_to_Vector
    USE ENTITY work.mw_ssrconverter_src_SSR_to_Vector(rtl);

  FOR ALL : mw_ssrconverter_src_HDL_FIFO1
    USE ENTITY work.mw_ssrconverter_src_HDL_FIFO1(rtl);
...
BEGIN
  u_Subsystem : mw_ssrconverter_src_Subsystem
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Set => AND2_out1,
  ...
  u_HDL_FIFO : mw_ssrconverter_src_HDL_FIFO
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem1 : mw_ssrconverter_src_Subsystem1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Set => Unit_Delay_out1,
  ...
  u_SSR_to_Vector : mw_ssrconverter_src_SSR_to_Vector
    PORT MAP( SSR => HDL_FIFO_out1,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_HDL_FIFO1 : mw_ssrconverter_src_HDL_FIFO1
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
