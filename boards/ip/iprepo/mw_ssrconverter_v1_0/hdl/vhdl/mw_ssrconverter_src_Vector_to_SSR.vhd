-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_Vector_to_SSR.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_Vector_to_SSR
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Serializer Imag/Vector to SSR
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_Vector_to_SSR IS
  PORT( Vector                            :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
        SSR                               :   OUT   std_logic_vector(127 DOWNTO 0)  -- ufix128
        );
END mw_ssrconverter_src_Vector_to_SSR;


ARCHITECTURE rtl OF mw_ssrconverter_src_Vector_to_SSR IS
