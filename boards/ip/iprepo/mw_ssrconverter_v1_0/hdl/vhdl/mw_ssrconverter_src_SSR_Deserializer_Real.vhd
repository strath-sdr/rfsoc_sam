-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_SSR_Deserializer_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_SSR_Deserializer_Real
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Deserializer Real
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_SSR_Deserializer_Real IS
...
END mw_ssrconverter_src_SSR_Deserializer_Real;


ARCHITECTURE rtl OF mw_ssrconverter_src_SSR_Deserializer_Real IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_src_Subsystem_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  COMPONENT mw_ssrconverter_src_HDL_FIFO_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_ssrconverter_src_Subsystem1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Set                             :   IN    std_logic;
  ...
  FOR ALL : mw_ssrconverter_src_Subsystem_block
    USE ENTITY work.mw_ssrconverter_src_Subsystem_block(rtl);

  FOR ALL : mw_ssrconverter_src_HDL_FIFO_block
    USE ENTITY work.mw_ssrconverter_src_HDL_FIFO_block(rtl);

  FOR ALL : mw_ssrconverter_src_Subsystem1_block
    USE ENTITY work.mw_ssrconverter_src_Subsystem1_block(rtl);

  FOR ALL : mw_ssrconverter_src_SSR_to_Vector_block
    USE ENTITY work.mw_ssrconverter_src_SSR_to_Vector_block(rtl);

  FOR ALL : mw_ssrconverter_src_HDL_FIFO1_block
    USE ENTITY work.mw_ssrconverter_src_HDL_FIFO1_block(rtl);
...
BEGIN
  u_Subsystem : mw_ssrconverter_src_Subsystem_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Set => AND2_out1,
  ...
  u_HDL_FIFO : mw_ssrconverter_src_HDL_FIFO_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_Subsystem1 : mw_ssrconverter_src_Subsystem1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Set => Unit_Delay_out1,
  ...
  u_SSR_to_Vector : mw_ssrconverter_src_SSR_to_Vector_block
    PORT MAP( SSR => HDL_FIFO_out1,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_HDL_FIFO1 : mw_ssrconverter_src_HDL_FIFO1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
