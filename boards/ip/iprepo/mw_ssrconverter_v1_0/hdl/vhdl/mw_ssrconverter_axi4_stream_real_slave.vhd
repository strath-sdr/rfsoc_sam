-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_axi4_stream_real_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_axi4_stream_real_slave
-- Source Path: mw_ssrconverter/mw_ssrconverter_axi4_stream_real_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_axi4_stream_real_slave IS
...
END mw_ssrconverter_axi4_stream_real_slave;


ARCHITECTURE rtl OF mw_ssrconverter_axi4_stream_real_slave IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : mw_ssrconverter_fifo_data
    USE ENTITY work.mw_ssrconverter_fifo_data(rtl);
...
BEGIN
  u_mw_ssrconverter_fifo_data_inst : mw_ssrconverter_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
