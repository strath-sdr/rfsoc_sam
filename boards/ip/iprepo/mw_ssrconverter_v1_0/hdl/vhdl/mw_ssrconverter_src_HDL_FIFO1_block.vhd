-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_HDL_FIFO1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_HDL_FIFO1_block
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Deserializer Real/HDL_FIFO1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_HDL_FIFO1_block IS
...
END mw_ssrconverter_src_HDL_FIFO1_block;


ARCHITECTURE rtl OF mw_ssrconverter_src_HDL_FIFO1_block IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_src_SimpleDualPortRAM_generic
  ...
  FOR ALL : mw_ssrconverter_src_SimpleDualPortRAM_generic
    USE ENTITY work.mw_ssrconverter_src_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_HDL_FIFO1_ram : mw_ssrconverter_src_SimpleDualPortRAM_generic
