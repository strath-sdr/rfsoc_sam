-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_SSR_Packet_Generator_Imag.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_SSR_Packet_Generator_Imag
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Packet Generator Imag
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_SSR_Packet_Generator_Imag IS
...
END mw_ssrconverter_src_SSR_Packet_Generator_Imag;


ARCHITECTURE rtl OF mw_ssrconverter_src_SSR_Packet_Generator_Imag IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_src_TLAST_Generator
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  COMPONENT mw_ssrconverter_src_Frame_Dropper
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Valid_In                        :   IN    std_logic;
  ...
  FOR ALL : mw_ssrconverter_src_TLAST_Generator
    USE ENTITY work.mw_ssrconverter_src_TLAST_Generator(rtl);

  FOR ALL : mw_ssrconverter_src_Frame_Dropper
    USE ENTITY work.mw_ssrconverter_src_Frame_Dropper(rtl);
...
BEGIN
  u_TLAST_Generator : mw_ssrconverter_src_TLAST_Generator
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Valid_In => Valid_In,
  ...
  u_Frame_Dropper : mw_ssrconverter_src_Frame_Dropper
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
