-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_src_SSR_Serializer_Real.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_src_SSR_Serializer_Real
-- Source Path: mw_ssrconverter/SSR Subset Converter/SSR Serializer Real
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_src_SSR_Serializer_Real IS
...
END mw_ssrconverter_src_SSR_Serializer_Real;


ARCHITECTURE rtl OF mw_ssrconverter_src_SSR_Serializer_Real IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_src_SSR_to_Vector_block2
    PORT( SSR                             :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
          Vector                          :   OUT   vector_of_std_logic_vector16(0 TO 7)  -- uint16 [8]
          );
  END COMPONENT;

  COMPONENT mw_ssrconverter_src_SSR1_to_SSR8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_ssrconverter_src_SSR2_to_SSR8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT mw_ssrconverter_src_SSR4_to_SSR8_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          Data_In                         :   IN    vector_of_std_logic_vector16(0 TO 7);  -- uint16 [8]
  ...
  COMPONENT mw_ssrconverter_src_Vector_to_SSR_block
  ...
  FOR ALL : mw_ssrconverter_src_SSR_to_Vector_block2
    USE ENTITY work.mw_ssrconverter_src_SSR_to_Vector_block2(rtl);

  FOR ALL : mw_ssrconverter_src_SSR1_to_SSR8_block
    USE ENTITY work.mw_ssrconverter_src_SSR1_to_SSR8_block(rtl);

  FOR ALL : mw_ssrconverter_src_SSR2_to_SSR8_block
    USE ENTITY work.mw_ssrconverter_src_SSR2_to_SSR8_block(rtl);

  FOR ALL : mw_ssrconverter_src_SSR4_to_SSR8_block
    USE ENTITY work.mw_ssrconverter_src_SSR4_to_SSR8_block(rtl);

  FOR ALL : mw_ssrconverter_src_Vector_to_SSR_block
    USE ENTITY work.mw_ssrconverter_src_Vector_to_SSR_block(rtl);
...
BEGIN
  u_SSR_to_Vector : mw_ssrconverter_src_SSR_to_Vector_block2
    PORT MAP( SSR => Data_In,  -- ufix128
              Vector => SSR_to_Vector_out1  -- uint16 [8]
              );

  u_SSR1_to_SSR8 : mw_ssrconverter_src_SSR1_to_SSR8_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SSR2_to_SSR8 : mw_ssrconverter_src_SSR2_to_SSR8_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_SSR4_to_SSR8 : mw_ssrconverter_src_SSR4_to_SSR8_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              Data_In => SSR_to_Vector_out1,  -- uint16 [8]
  ...
  u_Vector_to_SSR : mw_ssrconverter_src_Vector_to_SSR_block
