-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_ssrconverter\mw_ssrconverter_fifo_TLAST_OUT_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_ssrconverter_fifo_TLAST_OUT_block
-- Source Path: mw_ssrconverter/mw_ssrconverter_axi4_stream_imag_master/mw_ssrconverter_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_ssrconverter_fifo_TLAST_OUT_block IS
...
END mw_ssrconverter_fifo_TLAST_OUT_block;


ARCHITECTURE rtl OF mw_ssrconverter_fifo_TLAST_OUT_block IS

  -- Component Declarations
  COMPONENT mw_ssrconverter_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : mw_ssrconverter_SimpleDualPortRAM_singlebit
    USE ENTITY work.mw_ssrconverter_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_mw_ssrconverter_fifo_TLAST_OUT_classic_ram : mw_ssrconverter_SimpleDualPortRAM_singlebit
