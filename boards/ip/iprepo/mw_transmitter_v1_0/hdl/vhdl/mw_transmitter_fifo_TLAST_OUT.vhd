-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_transmitter\mw_transmitter_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_transmitter_fifo_TLAST_OUT
-- Source Path: mw_transmitter/mw_transmitter_axi4_stream_master/mw_transmitter_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_transmitter_fifo_TLAST_OUT IS
...
END mw_transmitter_fifo_TLAST_OUT;


ARCHITECTURE rtl OF mw_transmitter_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT mw_transmitter_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : mw_transmitter_SimpleDualPortRAM_singlebit
    USE ENTITY work.mw_transmitter_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_mw_transmitter_fifo_TLAST_OUT_classic_ram_singlebit : mw_transmitter_SimpleDualPortRAM_singlebit
