-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_transmitter\mw_transmitter_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_transmitter_fifo_data_OUT
-- Source Path: mw_transmitter/mw_transmitter_axi4_stream_master/mw_transmitter_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_transmitter_fifo_data_OUT IS
...
END mw_transmitter_fifo_data_OUT;


ARCHITECTURE rtl OF mw_transmitter_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT mw_transmitter_SimpleDualPortRAM_generic
  ...
  FOR ALL : mw_transmitter_SimpleDualPortRAM_generic
    USE ENTITY work.mw_transmitter_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_mw_transmitter_fifo_data_OUT_classic_ram_generic : mw_transmitter_SimpleDualPortRAM_generic
