-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_SDFCommutator11_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_SDFCommutator11_block1
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 8192/RADIX22FFT_SDF1_11/SDFCommutator11
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_SDFCommutator11_block1 IS
...
END mw_spectrumanalyser_src_SDFCommutator11_block1;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_SDFCommutator11_block1 IS
...
BEGIN
  u_dataXMEM_re_0_11 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_11 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 27
                 )
    PORT MAP( clk => clk,
