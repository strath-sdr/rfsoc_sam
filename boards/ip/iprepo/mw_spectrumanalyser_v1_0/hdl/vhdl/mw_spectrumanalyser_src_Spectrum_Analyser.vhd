...
ENTITY mw_spectrumanalyser_src_Spectrum_Analyser IS
  PORT( clk                               :   IN    std_logic;
        ...
        Bypass                            :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
...
ARCHITECTURE rtl OF mw_spectrumanalyser_src_Spectrum_Analyser IS
  ...
  SIGNAL Bypass_unsigned                  : unsigned(31 DOWNTO 0);  -- uint32
  ...
  SIGNAL mergedInput                      : unsigned(34 DOWNTO 0);  -- ufix35
  SIGNAL mergedDelay_regin                : unsigned(34 DOWNTO 0);  -- ufix35
  SIGNAL mergedDelay_waddr                : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL mergedDelay_wrenb                : std_logic;  -- ufix1
  SIGNAL mergedDelay_raddr                : unsigned(13 DOWNTO 0);  -- ufix14
  SIGNAL mergedDelay_regout               : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL mergedDelay_regout_unsigned      : unsigned(34 DOWNTO 0);  -- ufix35
  SIGNAL mergedOutput                     : unsigned(34 DOWNTO 0);  -- ufix35
...
BEGIN
  ...
  u_ShiftRegisterRAM : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  Bypass_unsigned <= unsigned(Bypass);

  Bit_Slice_out1 <= Bypass_unsigned(0);
  ...
  mergedInput <= Bit_Concat_out1 & unsigned'(Convert_Data_out2 & AND_out1 & AND1_out1);
  ...
  BEGIN
    IF reset = '1' THEN
      mergedDelay_regin <= to_unsigned(0, 35);
  ...
  BEGIN
    IF reset = '1' THEN
      mergedDelay_waddr <= to_unsigned(16#0000#, 14);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
        IF mergedDelay_waddr >= to_unsigned(16#202B#, 14) THEN 
          mergedDelay_waddr <= to_unsigned(16#0000#, 14);
        ELSE 
          mergedDelay_waddr <= mergedDelay_waddr + to_unsigned(16#0001#, 14);
        END IF;
      END IF;
    END IF;
  ...
  BEGIN
    IF reset = '1' THEN
      mergedDelay_raddr <= to_unsigned(16#0001#, 14);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb_1_16_0 = '1' THEN
        IF mergedDelay_raddr >= to_unsigned(16#202B#, 14) THEN 
          mergedDelay_raddr <= to_unsigned(16#0000#, 14);
        ELSE 
          mergedDelay_raddr <= mergedDelay_raddr + to_unsigned(16#0001#, 14);
        END IF;
      END IF;
    END IF;
  ...
  Delay1_out1 <= '1' WHEN slicedInput /= '0' ELSE
      '0';
  ...
  slicedInput_1 <= mergedOutput(34 DOWNTO 3);

  Delay_out1 <= slicedInput_1;
  ...
  Delay_out1_1 <= delayMatch1_reg(147);
  delayMatch1_reg_next(0) <= Delay_out1;
  ...
  Delay3_out1 <= '1' WHEN slicedInput_2 /= '0' ELSE
      '0';
  ...
  slicedInput_3 <= mergedOutput(1);

  
  Delay2_out1 <= '1' WHEN slicedInput_3 /= '0' ELSE
      '0';
