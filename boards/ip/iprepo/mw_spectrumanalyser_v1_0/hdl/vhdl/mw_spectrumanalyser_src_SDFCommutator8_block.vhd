-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_SDFCommutator8_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_SDFCommutator8_block
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 2048/RADIX22FFT_SDF2_8/SDFCommutator8
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_SDFCommutator8_block IS
...
END mw_spectrumanalyser_src_SDFCommutator8_block;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_SDFCommutator8_block IS
...
BEGIN
  u_dataXMEM_re_0_8 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_8 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
