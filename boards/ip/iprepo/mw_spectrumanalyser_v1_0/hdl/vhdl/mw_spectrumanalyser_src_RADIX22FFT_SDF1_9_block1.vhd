-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF1_9_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF1_9_block1
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 4096/RADIX22FFT_SDF1_9
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF1_9_block1 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF1_9_block1;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_9_block1 IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_Complex4Multiply_block17
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator9_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_9_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_Complex4Multiply_block17
    USE ENTITY work.mw_spectrumanalyser_src_Complex4Multiply_block17(rtl);
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator9_block1
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator9_block1(rtl);
...
BEGIN
  u_MUL4 : mw_spectrumanalyser_src_Complex4Multiply_block17
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_9 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_9 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 25
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_9 : mw_spectrumanalyser_src_SDFCommutator9_block1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_9_vld_dly => din_9_vld_dly,
