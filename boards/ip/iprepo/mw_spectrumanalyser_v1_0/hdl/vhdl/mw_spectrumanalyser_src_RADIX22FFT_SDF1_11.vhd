-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF1_11.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF1_11
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized/RADIX22FFT_SDF1_11
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF1_11 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF1_11;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_11 IS
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator11
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator11
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator11(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_11 : mw_spectrumanalyser_src_SDFCommutator11
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_11_vld_dly => din_11_vld_dly,
