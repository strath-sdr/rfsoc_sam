...
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 2048/RADIX22FFT_SDF1_11
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_11 IS
  ...
  COMPONENT mw_spectrumanalyser_src_Complex4Multiply_block10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_Complex4Multiply_block10
    USE ENTITY work.mw_spectrumanalyser_src_Complex4Multiply_block10(rtl);
...
BEGIN
  u_MUL4 : mw_spectrumanalyser_src_Complex4Multiply_block10
    PORT MAP( clk => clk,
              reset => reset,
