-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_axi4_stream_imag_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_axi4_stream_imag_slave
-- Source Path: mw_spectrumanalyser/mw_spectrumanalyser_axi4_stream_imag_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_axi4_stream_imag_slave IS
...
END mw_spectrumanalyser_axi4_stream_imag_slave;


ARCHITECTURE rtl OF mw_spectrumanalyser_axi4_stream_imag_slave IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_fifo_data_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_spectrumanalyser_fifo_TLAST_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_spectrumanalyser_fifo_TUSER_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : mw_spectrumanalyser_fifo_data_block
    USE ENTITY work.mw_spectrumanalyser_fifo_data_block(rtl);

  FOR ALL : mw_spectrumanalyser_fifo_TLAST_block
    USE ENTITY work.mw_spectrumanalyser_fifo_TLAST_block(rtl);

  FOR ALL : mw_spectrumanalyser_fifo_TUSER_block
    USE ENTITY work.mw_spectrumanalyser_fifo_TUSER_block(rtl);
...
BEGIN
  u_mw_spectrumanalyser_fifo_data_inst : mw_spectrumanalyser_fifo_data_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_mw_spectrumanalyser_fifo_TLAST_inst : mw_spectrumanalyser_fifo_TLAST_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_mw_spectrumanalyser_fifo_TUSER_inst : mw_spectrumanalyser_fifo_TUSER_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
