-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_axi_lite
-- Source Path: mw_spectrumanalyser/mw_spectrumanalyser_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_axi_lite IS
...
END mw_spectrumanalyser_axi_lite;


ARCHITECTURE rtl OF mw_spectrumanalyser_axi_lite IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_addr_decoder
  ...
  COMPONENT mw_spectrumanalyser_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : mw_spectrumanalyser_addr_decoder
    USE ENTITY work.mw_spectrumanalyser_addr_decoder(rtl);

  FOR ALL : mw_spectrumanalyser_axi_lite_module
    USE ENTITY work.mw_spectrumanalyser_axi_lite_module(rtl);
  ...
  SIGNAL write_Bypass_tmp                 : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_mw_spectrumanalyser_addr_decoder_inst : mw_spectrumanalyser_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_Bypass => write_Bypass_tmp  -- ufix32
              );

  u_mw_spectrumanalyser_axi_lite_module_inst : mw_spectrumanalyser_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
