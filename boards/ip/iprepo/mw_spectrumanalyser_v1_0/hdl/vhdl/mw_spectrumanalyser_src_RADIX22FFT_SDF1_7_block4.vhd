-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block4
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 512/RADIX22FFT_SDF1_7
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block4 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block4;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block4 IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_Complex4Multiply_block21
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator7_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_Complex4Multiply_block21
    USE ENTITY work.mw_spectrumanalyser_src_Complex4Multiply_block21(rtl);
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator7_block4
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator7_block4(rtl);
...
BEGIN
  u_MUL4 : mw_spectrumanalyser_src_Complex4Multiply_block21
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_dataMEM_im_0_7 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_7 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 2,
                 DataWidth => 23
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_7 : mw_spectrumanalyser_src_SDFCommutator7_block4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
