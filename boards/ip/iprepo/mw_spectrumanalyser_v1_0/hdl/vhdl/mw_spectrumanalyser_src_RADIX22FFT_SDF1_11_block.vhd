-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF1_11_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF1_11_block
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 4096/RADIX22FFT_SDF1_11
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF1_11_block IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF1_11_block;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_11_block IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_Complex4Multiply_block18
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator11_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_11_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_Complex4Multiply_block18
    USE ENTITY work.mw_spectrumanalyser_src_Complex4Multiply_block18(rtl);

  FOR ALL : mw_spectrumanalyser_src_SDFCommutator11_block
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator11_block(rtl);
...
BEGIN
  u_MUL4 : mw_spectrumanalyser_src_Complex4Multiply_block18
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_11 : mw_spectrumanalyser_src_SDFCommutator11_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_11_vld_dly => din_11_vld_dly,
