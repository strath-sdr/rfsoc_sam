-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block3
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 512/RADIX22FFT_SDF2_8
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block3 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block3;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block3 IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_SDFCommutator8_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator8_block3
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator8_block3(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_8 : mw_spectrumanalyser_src_SDFCommutator8_block3
    PORT MAP( clk => clk,
              reset => reset,
