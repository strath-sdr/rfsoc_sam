-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF1_13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF1_13
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 8192/RADIX22FFT_SDF1_13
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF1_13 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF1_13;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_13 IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_Complex4Multiply_block30
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator13
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_13_vld_dly                  :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_Complex4Multiply_block30
    USE ENTITY work.mw_spectrumanalyser_src_Complex4Multiply_block30(rtl);

  FOR ALL : mw_spectrumanalyser_src_SDFCommutator13
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator13(rtl);
...
BEGIN
  u_MUL4 : mw_spectrumanalyser_src_Complex4Multiply_block30
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_13 : mw_spectrumanalyser_src_SDFCommutator13
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_13_vld_dly => din_13_vld_dly,
