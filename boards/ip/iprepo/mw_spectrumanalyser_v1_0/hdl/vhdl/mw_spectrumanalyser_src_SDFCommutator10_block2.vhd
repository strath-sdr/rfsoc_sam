-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_SDFCommutator10_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_SDFCommutator10_block2
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 8192/RADIX22FFT_SDF2_10/SDFCommutator10
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_SDFCommutator10_block2 IS
...
END mw_spectrumanalyser_src_SDFCommutator10_block2;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_SDFCommutator10_block2 IS
...
BEGIN
  u_dataXMEM_re_0_10 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_10 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
