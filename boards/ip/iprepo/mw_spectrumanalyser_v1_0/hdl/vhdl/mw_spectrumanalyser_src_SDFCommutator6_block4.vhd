-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_SDFCommutator6_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_SDFCommutator6_block4
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 512/RADIX22FFT_SDF2_6/SDFCommutator6
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_SDFCommutator6_block4 IS
...
END mw_spectrumanalyser_src_SDFCommutator6_block4;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_SDFCommutator6_block4 IS
...
BEGIN
  u_dataXMEM_re_0_6 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_6 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 22
                 )
    PORT MAP( clk => clk,
