-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF2_4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF2_4
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized/RADIX22FFT_SDF2_4
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF2_4 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF2_4;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF2_4 IS
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator4
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator4(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : mw_spectrumanalyser_src_SDFCommutator4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
