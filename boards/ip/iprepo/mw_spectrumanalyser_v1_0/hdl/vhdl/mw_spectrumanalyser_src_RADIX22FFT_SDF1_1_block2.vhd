-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF1_1_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF1_1_block2
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 256/RADIX22FFT_SDF1_1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF1_1_block2 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF1_1_block2;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_1_block2 IS
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator1_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_1_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator1_block2
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator1_block2(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_1 : mw_spectrumanalyser_src_SDFCommutator1_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
