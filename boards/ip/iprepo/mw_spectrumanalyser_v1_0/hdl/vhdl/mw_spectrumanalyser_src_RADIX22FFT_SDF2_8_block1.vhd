-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block1
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 256/RADIX22FFT_SDF2_8
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block1 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block1;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block1 IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_SDFCommutator8_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator8_block1
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator8_block1(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_8 : mw_spectrumanalyser_src_SDFCommutator8_block1
    PORT MAP( clk => clk,
              reset => reset,
