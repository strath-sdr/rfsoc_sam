-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF2_10_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF2_10_block
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 2048/RADIX22FFT_SDF2_10
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF2_10_block IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF2_10_block;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF2_10_block IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_SDFCommutator10_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator10_block
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator10_block(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_10 : mw_spectrumanalyser_src_SDFCommutator10_block
    PORT MAP( clk => clk,
              reset => reset,
