-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_SDFCommutator12_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_SDFCommutator12_block
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 8192/RADIX22FFT_SDF2_12/SDFCommutator12
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_SDFCommutator12_block IS
...
END mw_spectrumanalyser_src_SDFCommutator12_block;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_SDFCommutator12_block IS
...
BEGIN
  u_dataXMEM_re_0_12 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_12 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 28
                 )
    PORT MAP( clk => clk,
