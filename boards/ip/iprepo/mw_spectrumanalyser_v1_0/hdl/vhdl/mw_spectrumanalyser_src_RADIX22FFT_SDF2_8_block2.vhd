-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block2
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 4096/RADIX22FFT_SDF2_8
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block2 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block2;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF2_8_block2 IS
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator8_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator8_block2
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator8_block2(rtl);
...
BEGIN
  u_dataMEM_im_0_8 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_8 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 4,
                 DataWidth => 24
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_8 : mw_spectrumanalyser_src_SDFCommutator8_block2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
