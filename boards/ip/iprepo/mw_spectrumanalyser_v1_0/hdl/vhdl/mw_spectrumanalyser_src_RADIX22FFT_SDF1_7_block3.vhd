-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block3
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 4096/RADIX22FFT_SDF1_7
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block3 IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block3;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF1_7_block3 IS

  -- Component Declarations
  COMPONENT mw_spectrumanalyser_src_Complex4Multiply_block16
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator7_block3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_Complex4Multiply_block16
    USE ENTITY work.mw_spectrumanalyser_src_Complex4Multiply_block16(rtl);
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator7_block3
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator7_block3(rtl);
...
BEGIN
  u_MUL4 : mw_spectrumanalyser_src_Complex4Multiply_block16
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_7 : mw_spectrumanalyser_src_SDFCommutator7_block3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
