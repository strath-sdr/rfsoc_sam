-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_SDFCommutator13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_SDFCommutator13
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 8192/RADIX22FFT_SDF1_13/SDFCommutator13
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_SDFCommutator13 IS
...
END mw_spectrumanalyser_src_SDFCommutator13;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_SDFCommutator13 IS
...
BEGIN
  u_dataXMEM_re_0_13 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_13 : mw_spectrumanalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 29
                 )
    PORT MAP( clk => clk,
