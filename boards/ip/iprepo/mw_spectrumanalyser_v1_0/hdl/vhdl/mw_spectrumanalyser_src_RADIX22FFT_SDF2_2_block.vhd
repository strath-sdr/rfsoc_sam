-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_spectrumanalyser\mw_spectrumanalyser_src_RADIX22FFT_SDF2_2_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_spectrumanalyser_src_RADIX22FFT_SDF2_2_block
-- Source Path: mw_spectrumanalyser/Spectrum Analyser/FFT Core/FFT HDL Optimized 128/RADIX22FFT_SDF2_2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_spectrumanalyser_src_RADIX22FFT_SDF2_2_block IS
...
END mw_spectrumanalyser_src_RADIX22FFT_SDF2_2_block;


ARCHITECTURE rtl OF mw_spectrumanalyser_src_RADIX22FFT_SDF2_2_block IS
  ...
  COMPONENT mw_spectrumanalyser_src_SDFCommutator2_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : mw_spectrumanalyser_src_SDFCommutator2_block
    USE ENTITY work.mw_spectrumanalyser_src_SDFCommutator2_block(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_2 : mw_spectrumanalyser_src_SDFCommutator2_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
