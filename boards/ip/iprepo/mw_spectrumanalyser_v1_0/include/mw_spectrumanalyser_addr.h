...
#define  IPCore_Timestamp_mw_spectrumanalyser   0x8  //contains unique IP timestamp (yymmddHHMM): 2012240922
...
#define  Selector_Data_mw_spectrumanalyser      0x114  //data register for Inport Selector
