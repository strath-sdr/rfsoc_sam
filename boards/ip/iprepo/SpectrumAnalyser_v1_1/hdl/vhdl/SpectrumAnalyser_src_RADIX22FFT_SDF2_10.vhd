-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF2_10.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF2_10
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF2_10 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF2_10;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF2_10 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_SDFCommutator10
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator10(rtl);
...
BEGIN
  u_SDFCOMMUTATOR_10 : SpectrumAnalyser_src_SDFCommutator10
    PORT MAP( clk => clk,
              reset => reset,
