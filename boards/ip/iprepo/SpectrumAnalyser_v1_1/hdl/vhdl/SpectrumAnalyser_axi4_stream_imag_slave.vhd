-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_axi4_stream_imag_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_axi4_stream_imag_slave
-- Source Path: SpectrumAnalyser/SpectrumAnalyser_axi4_stream_imag_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser_axi4_stream_imag_slave IS
...
END SpectrumAnalyser_axi4_stream_imag_slave;


ARCHITECTURE rtl OF SpectrumAnalyser_axi4_stream_imag_slave IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_fifo_data_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_fifo_data_block
    USE ENTITY work.SpectrumAnalyser_fifo_data_block(rtl);
...
BEGIN
  u_SpectrumAnalyser_fifo_data_inst : SpectrumAnalyser_fifo_data_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
