-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_HDL_FIFO1_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_HDL_FIFO1_block
...
ENTITY SpectrumAnalyser_src_HDL_FIFO1_block IS
...
END SpectrumAnalyser_src_HDL_FIFO1_block;


ARCHITECTURE rtl OF SpectrumAnalyser_src_HDL_FIFO1_block IS
...
BEGIN
  ...
  u_HDL_FIFO1_ram : SpectrumAnalyser_src_SimpleDualPortRAM_generic
