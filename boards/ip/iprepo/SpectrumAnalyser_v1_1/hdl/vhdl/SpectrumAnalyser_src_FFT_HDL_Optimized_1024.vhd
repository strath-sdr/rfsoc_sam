-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_FFT_HDL_Optimized_1024.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_FFT_HDL_Optimized_1024
...
ENTITY SpectrumAnalyser_src_FFT_HDL_Optimized_1024 IS
...
END SpectrumAnalyser_src_FFT_HDL_Optimized_1024;


ARCHITECTURE rtl OF SpectrumAnalyser_src_FFT_HDL_Optimized_1024 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_TWDLROM_3_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_3
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_TWDLROM_5_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_6
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_TWDLROM_7_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_TWDLROM_9_1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF1_9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_CTRL1_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX22FFT_SDF2_10
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_RADIX2FFT_bitNatural
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_1
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_1(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_1
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_1(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_2
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_2(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_2
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_2(rtl);

  FOR ALL : SpectrumAnalyser_src_TWDLROM_3_1
    USE ENTITY work.SpectrumAnalyser_src_TWDLROM_3_1(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_3
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_3(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_3
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_3(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_4
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_4(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_4
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_4(rtl);

  FOR ALL : SpectrumAnalyser_src_TWDLROM_5_1
    USE ENTITY work.SpectrumAnalyser_src_TWDLROM_5_1(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_5
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_5(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_5
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_5(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_6
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_6(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_6
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_6(rtl);

  FOR ALL : SpectrumAnalyser_src_TWDLROM_7_1
    USE ENTITY work.SpectrumAnalyser_src_TWDLROM_7_1(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_7
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_7(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_7
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_7(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_8
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_8(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_8
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_8(rtl);

  FOR ALL : SpectrumAnalyser_src_TWDLROM_9_1
    USE ENTITY work.SpectrumAnalyser_src_TWDLROM_9_1(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_9
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_9(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF1_9
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF1_9(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_CTRL1_10
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_CTRL1_10(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX22FFT_SDF2_10
    USE ENTITY work.SpectrumAnalyser_src_RADIX22FFT_SDF2_10(rtl);

  FOR ALL : SpectrumAnalyser_src_RADIX2FFT_bitNatural
    USE ENTITY work.SpectrumAnalyser_src_RADIX2FFT_bitNatural(rtl);
...
BEGIN
  u_CTRL1_1_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDF1_1_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_2_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_1_1_vld => dout_1_1_vld,
  ...
  u_SDF2_2_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_2
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_1_1_re => dout_1_1_re,  -- sfix17_En15
  ...
  u_twdlROM_3_1 : SpectrumAnalyser_src_TWDLROM_3_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_2_1_vld => dout_2_1_vld,
  ...
  u_CTRL1_3_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_3_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_3
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_4_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_3_1_vld => dout_3_1_vld,
  ...
  u_SDF2_4_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_4
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_3_1_re => dout_3_1_re,  -- sfix19_En15
  ...
  u_twdlROM_5_1 : SpectrumAnalyser_src_TWDLROM_5_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_4_1_vld => dout_4_1_vld,
  ...
  u_CTRL1_5_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_5_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_6_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_6
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_5_1_vld => dout_5_1_vld,
  ...
  u_SDF2_6_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_6
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_5_1_re => dout_5_1_re,  -- sfix21_En15
  ...
  u_twdlROM_7_1 : SpectrumAnalyser_src_TWDLROM_7_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_6_1_vld => dout_6_1_vld,
  ...
  u_CTRL1_7_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_7_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_8_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_7_1_vld => dout_7_1_vld,
  ...
  u_SDF2_8_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_7_1_re => dout_7_1_re,  -- sfix23_En15
  ...
  u_twdlROM_9_1 : SpectrumAnalyser_src_TWDLROM_9_1
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_8_1_vld => dout_8_1_vld,
  ...
  u_CTRL1_9_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_9
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_SDF1_9_1 : SpectrumAnalyser_src_RADIX22FFT_SDF1_9
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
  ...
  u_CTRL2_10_1 : SpectrumAnalyser_src_RADIX22FFT_CTRL1_10
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_9_1_vld => dout_9_1_vld,
  ...
  u_SDF2_10_1 : SpectrumAnalyser_src_RADIX22FFT_SDF2_10
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_9_1_re => dout_9_1_re,  -- sfix25_En15
  ...
  u_NaturalOrder_Stage : SpectrumAnalyser_src_RADIX2FFT_bitNatural
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              dout_10_1_re => dout_10_1_re,  -- sfix26_En15
