-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_wlast_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_wlast_fifo
-- Source Path: SpectrumAnalyser/SpectrumAnalyser_axi4_master_wr/SpectrumAnalyser_wlast_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser_wlast_fifo IS
...
END SpectrumAnalyser_wlast_fifo;


ARCHITECTURE rtl OF SpectrumAnalyser_wlast_fifo IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : SpectrumAnalyser_SimpleDualPortRAM_singlebit
    USE ENTITY work.SpectrumAnalyser_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_SpectrumAnalyser_wlast_fifo_classic_ram_singlebit : SpectrumAnalyser_SimpleDualPortRAM_singlebit
