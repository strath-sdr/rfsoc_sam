-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF2_8.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF2_8
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF2_8 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF2_8;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF2_8 IS
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator8
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_7_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_SDFCommutator8
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator8(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_8 : SpectrumAnalyser_src_SDFCommutator8
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
