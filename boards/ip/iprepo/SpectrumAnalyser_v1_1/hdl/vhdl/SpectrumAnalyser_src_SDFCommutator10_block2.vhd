-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_SDFCommutator10_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_SDFCommutator10_block2
...
ENTITY SpectrumAnalyser_src_SDFCommutator10_block2 IS
...
END SpectrumAnalyser_src_SDFCommutator10_block2;


ARCHITECTURE rtl OF SpectrumAnalyser_src_SDFCommutator10_block2 IS
...
BEGIN
  u_dataXMEM_re_0_10 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_10 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 26
                 )
    PORT MAP( clk => clk,
