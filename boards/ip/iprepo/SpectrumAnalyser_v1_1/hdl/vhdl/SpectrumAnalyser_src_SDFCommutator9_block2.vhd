-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_SDFCommutator9_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_SDFCommutator9_block2
...
ENTITY SpectrumAnalyser_src_SDFCommutator9_block2 IS
...
END SpectrumAnalyser_src_SDFCommutator9_block2;


ARCHITECTURE rtl OF SpectrumAnalyser_src_SDFCommutator9_block2 IS
...
BEGIN
  u_dataXMEM_re_0_9 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_9 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 25
                 )
    PORT MAP( clk => clk,
