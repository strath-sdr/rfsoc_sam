-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_axi_lite_module
-- Source Path: SpectrumAnalyser/SpectrumAnalyser_axi_lite/SpectrumAnalyser_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser_axi_lite_module IS
...
END SpectrumAnalyser_axi_lite_module;


ARCHITECTURE rtl OF SpectrumAnalyser_axi_lite_module IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_reset_hold
    USE ENTITY work.SpectrumAnalyser_reset_hold(rtl);
...
BEGIN
  u_SpectrumAnalyser_reset_hold_inst : SpectrumAnalyser_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
