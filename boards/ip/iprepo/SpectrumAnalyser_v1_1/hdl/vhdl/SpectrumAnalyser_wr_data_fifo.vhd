-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_wr_data_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_wr_data_fifo
-- Source Path: SpectrumAnalyser/SpectrumAnalyser_axi4_master_wr/SpectrumAnalyser_wr_data_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser_wr_data_fifo IS
...
END SpectrumAnalyser_wr_data_fifo;


ARCHITECTURE rtl OF SpectrumAnalyser_wr_data_fifo IS
...
BEGIN
  ...
  u_SpectrumAnalyser_wr_data_fifo_classic_ram : SpectrumAnalyser_SimpleDualPortRAM_generic
