-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_SDFCommutator1_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_SDFCommutator1_block4
...
ENTITY SpectrumAnalyser_src_SDFCommutator1_block4 IS
...
END SpectrumAnalyser_src_SDFCommutator1_block4;


ARCHITECTURE rtl OF SpectrumAnalyser_src_SDFCommutator1_block4 IS
...
BEGIN
  u_dataXMEM_re_0_1 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_1 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 17
                 )
    PORT MAP( clk => clk,
