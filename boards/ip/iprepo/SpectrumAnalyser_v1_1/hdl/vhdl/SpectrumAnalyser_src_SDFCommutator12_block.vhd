-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_SDFCommutator12_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_SDFCommutator12_block
...
ENTITY SpectrumAnalyser_src_SDFCommutator12_block IS
...
END SpectrumAnalyser_src_SDFCommutator12_block;


ARCHITECTURE rtl OF SpectrumAnalyser_src_SDFCommutator12_block IS
...
BEGIN
  u_dataXMEM_re_0_12 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_12 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 28
                 )
    PORT MAP( clk => clk,
