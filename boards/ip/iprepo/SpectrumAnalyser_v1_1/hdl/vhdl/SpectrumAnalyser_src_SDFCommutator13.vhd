-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_SDFCommutator13.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_SDFCommutator13
...
ENTITY SpectrumAnalyser_src_SDFCommutator13 IS
...
END SpectrumAnalyser_src_SDFCommutator13;


ARCHITECTURE rtl OF SpectrumAnalyser_src_SDFCommutator13 IS
...
BEGIN
  u_dataXMEM_re_0_13 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataXMEM_im_0_13 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 29
                 )
    PORT MAP( clk => clk,
