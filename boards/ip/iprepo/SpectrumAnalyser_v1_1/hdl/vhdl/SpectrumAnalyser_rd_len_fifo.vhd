-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_rd_len_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_rd_len_fifo
-- Source Path: SpectrumAnalyser/SpectrumAnalyser_axi4_master_rd/SpectrumAnalyser_rd_len_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SpectrumAnalyser_rd_len_fifo IS
...
END SpectrumAnalyser_rd_len_fifo;


ARCHITECTURE rtl OF SpectrumAnalyser_rd_len_fifo IS
...
BEGIN
  ...
  u_SpectrumAnalyser_rd_len_fifo_classic_ram : SpectrumAnalyser_SimpleDualPortRAM_generic
