-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block IS
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator4_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_SDFCommutator4_block
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator4_block(rtl);
...
BEGIN
  u_dataMEM_im_0_4 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_0_4 : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,
  ...
  u_SDFCOMMUTATOR_4 : SpectrumAnalyser_src_SDFCommutator4_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
