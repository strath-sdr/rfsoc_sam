-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF1_9.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF1_9
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF1_9 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF1_9;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF1_9 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_Complex4Multiply_block2
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator9
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_9_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_Complex4Multiply_block2
    USE ENTITY work.SpectrumAnalyser_src_Complex4Multiply_block2(rtl);

  FOR ALL : SpectrumAnalyser_src_SDFCommutator9
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator9(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser_src_Complex4Multiply_block2
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_9 : SpectrumAnalyser_src_SDFCommutator9
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_9_vld_dly => din_9_vld_dly,
