-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF1_7.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF1_7
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF1_7 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF1_7;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF1_7 IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_Complex4Multiply_block1
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator7
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_7_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_Complex4Multiply_block1
    USE ENTITY work.SpectrumAnalyser_src_Complex4Multiply_block1(rtl);

  FOR ALL : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : SpectrumAnalyser_src_SDFCommutator7
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator7(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser_src_Complex4Multiply_block1
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_7 : SpectrumAnalyser_src_SDFCommutator7
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_7_vld_dly => din_7_vld_dly,
