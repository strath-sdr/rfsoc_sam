-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block5
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block5 IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block5;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF2_4_block5 IS
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator4_block5
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          dout_3_1_vld                    :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_SDFCommutator4_block5
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator4_block5(rtl);
...
BEGIN
  ...
  u_SDFCOMMUTATOR_4 : SpectrumAnalyser_src_SDFCommutator4_block5
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
