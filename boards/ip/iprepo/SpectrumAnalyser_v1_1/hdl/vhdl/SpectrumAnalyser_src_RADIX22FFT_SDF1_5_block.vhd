-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\spectrum_analyser\SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block
...
ENTITY SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block IS
...
END SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block;


ARCHITECTURE rtl OF SpectrumAnalyser_src_RADIX22FFT_SDF1_5_block IS

  -- Component Declarations
  COMPONENT SpectrumAnalyser_src_Complex4Multiply_block4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
  ...
  COMPONENT SpectrumAnalyser_src_SDFCommutator5_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb_1_16_0                      :   IN    std_logic;
          din_5_vld_dly                   :   IN    std_logic;
  ...
  FOR ALL : SpectrumAnalyser_src_Complex4Multiply_block4
    USE ENTITY work.SpectrumAnalyser_src_Complex4Multiply_block4(rtl);

  FOR ALL : SpectrumAnalyser_src_SimpleDualPortRAM_generic
    USE ENTITY work.SpectrumAnalyser_src_SimpleDualPortRAM_generic(rtl);

  FOR ALL : SpectrumAnalyser_src_SDFCommutator5_block
    USE ENTITY work.SpectrumAnalyser_src_SDFCommutator5_block(rtl);
...
BEGIN
  u_MUL4 : SpectrumAnalyser_src_Complex4Multiply_block4
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_SDFCOMMUTATOR_5 : SpectrumAnalyser_src_SDFCommutator5_block
    PORT MAP( clk => clk,
              reset => reset,
              enb_1_16_0 => enb_1_16_0,
              din_5_vld_dly => din_5_vld_dly,
