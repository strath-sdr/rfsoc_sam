-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_autodma\mw_autodma_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_autodma_axi_lite
-- Source Path: mw_autodma/mw_autodma_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END mw_autodma_axi_lite;


ARCHITECTURE rtl OF mw_autodma_axi_lite IS

  -- Component Declarations
  COMPONENT mw_autodma_addr_decoder
  ...
  COMPONENT mw_autodma_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : mw_autodma_addr_decoder
    USE ENTITY work.mw_autodma_addr_decoder(rtl);

  FOR ALL : mw_autodma_axi_lite_module
    USE ENTITY work.mw_autodma_axi_lite_module(rtl);
...
BEGIN
  u_mw_autodma_addr_decoder_inst : mw_autodma_addr_decoder
  ...
  u_mw_autodma_axi_lite_module_inst : mw_autodma_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
