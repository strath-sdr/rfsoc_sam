...
BEGIN
  ...
  debug_signals_dma_status <= std_logic_vector(dma_status_1);

  debug_signals_wr_m2s_wr_addr <= std_logic_vector(wr_addr_1);

  debug_signals_wr_m2s_wr_len <= std_logic_vector(wr_len_1);

  Buffer_Pointer <= buffer_rsvd;

  wr_data <= wr_data_tmp;

  debug_signals_wr_m2s_wr_valid <= wr_valid_1;

  debug_signals_wr_data <= wr_data_tmp;

  debug_signals_wr_ready <= wr_ready_wr_ready;

  debug_signals_wr_complete <= wr_ready_wr_complete;
