-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_autodma\mw_autodma_axi4_master_wr.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_autodma_axi4_master_wr
-- Source Path: mw_autodma/mw_autodma_axi4_master_wr
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_autodma_axi4_master_wr IS
...
END mw_autodma_axi4_master_wr;


ARCHITECTURE rtl OF mw_autodma_axi4_master_wr IS

  -- Component Declarations
  COMPONENT mw_autodma_wdata_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT mw_autodma_wr_addr_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT mw_autodma_wr_data_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT mw_autodma_wr_len_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  COMPONENT mw_autodma_wlast_fifo
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : mw_autodma_wdata_fifo
    USE ENTITY work.mw_autodma_wdata_fifo(rtl);

  FOR ALL : mw_autodma_wr_addr_fifo
    USE ENTITY work.mw_autodma_wr_addr_fifo(rtl);

  FOR ALL : mw_autodma_wr_data_fifo
    USE ENTITY work.mw_autodma_wr_data_fifo(rtl);

  FOR ALL : mw_autodma_wr_len_fifo
    USE ENTITY work.mw_autodma_wr_len_fifo(rtl);

  FOR ALL : mw_autodma_wlast_fifo
    USE ENTITY work.mw_autodma_wlast_fifo(rtl);
...
BEGIN
  u_mw_autodma_wdata_fifo_inst : mw_autodma_wdata_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_mw_autodma_wr_addr_fifo_inst : mw_autodma_wr_addr_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_mw_autodma_wr_data_fifo_inst : mw_autodma_wr_data_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_mw_autodma_wr_len_fifo_inst : mw_autodma_wr_len_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
  ...
  u_mw_autodma_wlast_fifo_inst : mw_autodma_wlast_fifo
    PORT MAP( clk => clk,
              reset => reset,
              enb => const_1_1,
