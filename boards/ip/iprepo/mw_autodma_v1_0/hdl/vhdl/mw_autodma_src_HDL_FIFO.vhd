-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_autodma\mw_autodma_src_HDL_FIFO.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_autodma_src_HDL_FIFO
-- Source Path: mw_autodma/mw_autodma/Direct Memory Access/DDR Communication/HDL_FIFO
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_autodma_src_HDL_FIFO IS
...
END mw_autodma_src_HDL_FIFO;


ARCHITECTURE rtl OF mw_autodma_src_HDL_FIFO IS

  -- Component Declarations
  COMPONENT mw_autodma_src_SimpleDualPortRAM_generic
  ...
  FOR ALL : mw_autodma_src_SimpleDualPortRAM_generic
    USE ENTITY work.mw_autodma_src_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_HDL_FIFO_ram_generic : mw_autodma_src_SimpleDualPortRAM_generic
