-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_autodma\mw_autodma_fifo_TLAST.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_autodma_fifo_TLAST
-- Source Path: mw_autodma/mw_autodma_axi4_stream_slave/mw_autodma_fifo_TLAST
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_autodma_fifo_TLAST IS
...
END mw_autodma_fifo_TLAST;


ARCHITECTURE rtl OF mw_autodma_fifo_TLAST IS

  -- Component Declarations
  COMPONENT mw_autodma_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : mw_autodma_SimpleDualPortRAM_singlebit
    USE ENTITY work.mw_autodma_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_mw_autodma_fifo_TLAST_classic_ram_singlebit : mw_autodma_SimpleDualPortRAM_singlebit
