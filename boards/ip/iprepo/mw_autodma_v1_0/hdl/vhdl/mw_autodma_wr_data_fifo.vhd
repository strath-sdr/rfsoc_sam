-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_autodma\mw_autodma_wr_data_fifo.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_autodma_wr_data_fifo
-- Source Path: mw_autodma/mw_autodma_axi4_master_wr/mw_autodma_wr_data_fifo
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_autodma_wr_data_fifo IS
...
END mw_autodma_wr_data_fifo;


ARCHITECTURE rtl OF mw_autodma_wr_data_fifo IS

  -- Component Declarations
  COMPONENT mw_autodma_SimpleDualPortRAM_generic
  ...
  FOR ALL : mw_autodma_SimpleDualPortRAM_generic
    USE ENTITY work.mw_autodma_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_mw_autodma_wr_data_fifo_classic_ram : mw_autodma_SimpleDualPortRAM_generic
