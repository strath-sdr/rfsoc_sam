-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\mw_autodma\mw_autodma_axi_lite_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: mw_autodma_axi_lite_module
-- Source Path: mw_autodma/mw_autodma_axi_lite/mw_autodma_axi_lite_module
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY mw_autodma_axi_lite_module IS
...
END mw_autodma_axi_lite_module;


ARCHITECTURE rtl OF mw_autodma_axi_lite_module IS

  -- Component Declarations
  COMPONENT mw_autodma_reset_hold
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  FOR ALL : mw_autodma_reset_hold
    USE ENTITY work.mw_autodma_reset_hold(rtl);
...
BEGIN
  u_mw_autodma_reset_hold_inst : mw_autodma_reset_hold
    PORT MAP( clk => clk,
              reset => reset,
              reset_in => soft_reset,  -- ufix1
              in_burst => in_burst_axi4_master_wr,  -- ufix1
