...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC_Data_Width20 {9} \
   CONFIG.ADC_Data_Width21 {9} \
...
proc create_root_design { parentCell } {
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces radio/receiver/channel_12/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH]
